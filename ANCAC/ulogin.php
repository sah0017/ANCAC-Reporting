...
//--- Make it so this works for every page by finding the current filename.
        ...
        if($_POST['Login'] != 1)
        {
            ...
            echo "<tr><td colspan='2' class='login' align=center><input type=hidden value=on name=keeplog></td></tr><tr><td colspan='2' class='login' align=center><input type='SUBMIT' value='Login'><br><br><a href=forgotpw.php>Forgot Password?</a></td></tr></form></table></div><br><br>Note: This application requires cookies to be enabled.";
            exit;
        }
        else
        {
