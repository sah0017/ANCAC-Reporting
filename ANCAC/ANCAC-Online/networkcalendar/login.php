...
<tr><td rowspan="2">
 ...
 <input name="login" value=ANCAC id="user" size="15" maxlength="25" 
   value="<?php if ( ! empty ( $last_login ) ) echo $last_login;?>" 
   tabindex="1" />
</td></tr>
<tr><td style="text-align:right;">
 <label for="password"><?php etranslate("Password")?>:</label></td><td>
 <input name="password" value=kjflksfj3 id="password" type="password" size="15" 
   maxlength="30" tabindex="2" />
</td></tr>
<tr><td colspan="3" style="font-size: 10px;">
 <input type="hidden" value=yes name="remember" id="remember" tabindex="3" 
   <?php if ( ! empty ( $remember ) && $remember == "yes" ) {
...
<?php if ( ! empty ( $public_access ) && $public_access == "Y" ) { ?>
 ...
 <a class="nav" href="index.php">
   <?php etranslate("Click Here to View Public Calendar")?></a><br />
<?php } ?>
