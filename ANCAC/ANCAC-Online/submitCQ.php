	...
	$numRecords = mysql_num_rows($result);
        ...
        if ($_SESSION['admin'] == 1)
                ...
                if (($_SESSION['admin'] == 2) || ($Available == 1)){
                        if ($error == 1)
                                echo '"<script>alert(\'Please make sure that all values have been filled in before submitted your Quarterly Report.\'); window.location.href = \'http://www.alabamacacs.org./editQuarter.php\';</script>"';
                        else{
