...
<tr>
	<td class='login-header' colspan='2' align=center><? echo $CenterName; ?> Editing Budgets - FY <? echo $fiscalYear; ?><br></td>
</tr>
<tr>
              ...
              " AND budgetedPerfStats.quarter = 4";
                ...
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->personnelCosts)){ echo $row1QBudgeted->personnelCosts; $ExpenseBud1[] = $row1QBudgeted->personnelCosts;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="personnelCosts2"
                                value="<? if(isset($row2QBudgeted->personnelCosts)){ echo $row2QBudgeted->personnelCosts; $ExpenseBud2[] = $row2QBudgeted->personnelCosts;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="personnelCosts3"
                                value="<? if(isset($row3QBudgeted->personnelCosts)){ echo $row3QBudgeted->personnelCosts; $ExpenseBud3[] = $row3QBudgeted->personnelCosts;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="personnelCosts4"
                                value="<? if(isset($row4QBudgeted->personnelCosts)){ echo $row4QBudgeted->personnelCosts; $ExpenseBud4[] = $row4QBudgeted->personnelCosts;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->empBenefits)){ echo $row1QBudgeted->empBenefits; $ExpenseBud1[] = $row1QBudgeted->empBenefits;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="empBenefits2"
                                value="<? if(isset($row2QBudgeted->empBenefits)){ echo $row2QBudgeted->empBenefits; $ExpenseBud2[] = $row2QBudgeted->empBenefits;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="empBenefits3"
                                value="<? if(isset($row3QBudgeted->empBenefits)){ echo $row3QBudgeted->empBenefits; $ExpenseBud3[] = $row3QBudgeted->empBenefits;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="empBenefits4"
                                value="<? if(isset($row4QBudgeted->empBenefits)){ echo $row4QBudgeted->empBenefits; $ExpenseBud4[] = $row4QBudgeted->empBenefits;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->travelInState)){ echo $row1QBudgeted->travelInState; $ExpenseBud1[] = $row1QBudgeted->travelInState;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="travelInState2"
                                value="<? if(isset($row2QBudgeted->travelInState)){ echo $row2QBudgeted->travelInState; $ExpenseBud2[] = $row2QBudgeted->travelInState;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="travelInState3"
                                value="<? if(isset($row3QBudgeted->travelInState)){ echo $row3QBudgeted->travelInState; $ExpenseBud3[] = $row3QBudgeted->travelInState;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="travelInState4"
                                value="<? if(isset($row4QBudgeted->travelInState)){ echo $row4QBudgeted->travelInState; $ExpenseBud4[] = $row4QBudgeted->travelInState;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->travelOutState)){ echo $row1QBudgeted->travelOutState; $ExpenseBud1[] = $row1QBudgeted->travelOutState;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="travelOutState2"
                                value="<? if(isset($row2QBudgeted->travelOutState)){ echo $row2QBudgeted->travelOutState; $ExpenseBud2[] = $row2QBudgeted->travelOutState;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="travelOutState3"
                                value="<? if(isset($row3QBudgeted->travelOutState)){ echo $row3QBudgeted->travelOutState; $ExpenseBud3[] = $row3QBudgeted->travelOutState;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="travelOutState4"
                                value="<? if(isset($row4QBudgeted->travelOutState)){ echo $row4QBudgeted->travelOutState; $ExpenseBud4[] = $row4QBudgeted->travelOutState;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->repairsAndMx)){ echo $row1QBudgeted->repairsAndMx; $ExpenseBud1[] = $row1QBudgeted->repairsAndMx;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="repairsAndMx2"
                                value="<? if(isset($row2QBudgeted->repairsAndMx)){ echo $row2QBudgeted->repairsAndMx; $ExpenseBud2[] = $row2QBudgeted->repairsAndMx;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="repairsAndMx3"
                                value="<? if(isset($row3QBudgeted->repairsAndMx)){ echo $row3QBudgeted->repairsAndMx; $ExpenseBud3[] = $row3QBudgeted->repairsAndMx;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="repairsAndMx4"
                                value="<? if(isset($row4QBudgeted->repairsAndMx)){ echo $row4QBudgeted->repairsAndMx; $ExpenseBud4[] = $row4QBudgeted->repairsAndMx;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->rentalsLease)){ echo $row1QBudgeted->rentalsLease; $ExpenseBud1[] = $row1QBudgeted->rentalsLease;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="rentalsLease2"
                                value="<? if(isset($row2QBudgeted->rentalsLease)){ echo $row2QBudgeted->rentalsLease; $ExpenseBud2[] = $row2QBudgeted->rentalsLease;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="rentalsLease3"
                                value="<? if(isset($row3QBudgeted->rentalsLease)){ echo $row3QBudgeted->rentalsLease; $ExpenseBud3[] = $row3QBudgeted->rentalsLease;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="rentalsLease4"
                                value="<? if(isset($row4QBudgeted->rentalsLease)){ echo $row4QBudgeted->rentalsLease; $ExpenseBud4[] = $row4QBudgeted->rentalsLease;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->utilComm)){ echo $row1QBudgeted->utilComm; $ExpenseBud1[] = $row1QBudgeted->utilComm;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="utilComm2"
                                value="<? if(isset($row2QBudgeted->utilComm)){ echo $row2QBudgeted->utilComm; $ExpenseBud2[] = $row2QBudgeted->utilComm;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="utilComm3"
                                value="<? if(isset($row3QBudgeted->utilComm)){ echo $row3QBudgeted->utilComm; $ExpenseBud3[] = $row3QBudgeted->utilComm;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="utilComm4"
                                value="<? if(isset($row4QBudgeted->utilComm)){ echo $row4QBudgeted->utilComm; $ExpenseBud4[] = $row4QBudgeted->utilComm;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->profServ)){ echo $row1QBudgeted->profServ; $ExpenseBud1[] = $row1QBudgeted->profServ;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="profServ2"
                                value="<? if(isset($row2QBudgeted->profServ)){ echo $row2QBudgeted->profServ; $ExpenseBud2[] = $row2QBudgeted->profServ;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="profServ3"
                                value="<? if(isset($row3QBudgeted->profServ)){ echo $row3QBudgeted->profServ; $ExpenseBud3[] = $row3QBudgeted->profServ;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="profServ4"
                                value="<? if(isset($row4QBudgeted->profServ)){ echo $row4QBudgeted->profServ; $ExpenseBud4[] = $row4QBudgeted->profServ;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->suppMatOper)){ echo $row1QBudgeted->suppMatOper; $ExpenseBud1[] = $row1QBudgeted->suppMatOper;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="suppMatOper2"
                                value="<? if(isset($row2QBudgeted->suppMatOper)){ echo $row2QBudgeted->suppMatOper; $ExpenseBud2[] = $row2QBudgeted->suppMatOper;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="suppMatOper3"
                                value="<? if(isset($row3QBudgeted->suppMatOper)){ echo $row3QBudgeted->suppMatOper; $ExpenseBud3[] = $row3QBudgeted->suppMatOper;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="suppMatOper4"
                                value="<? if(isset($row4QBudgeted->suppMatOper)){ echo $row4QBudgeted->suppMatOper; $ExpenseBud4[] = $row4QBudgeted->suppMatOper;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->tranEqpPurch)){ echo $row1QBudgeted->tranEqpPurch; $ExpenseBud1[] = $row1QBudgeted->tranEqpPurch;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="tranEqpPurch2"
                                value="<? if(isset($row2QBudgeted->tranEqpPurch)){ echo $row2QBudgeted->tranEqpPurch; $ExpenseBud2[] = $row2QBudgeted->tranEqpPurch;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="tranEqpPurch3"
                                value="<? if(isset($row3QBudgeted->tranEqpPurch)){ echo $row3QBudgeted->tranEqpPurch; $ExpenseBud3[] = $row3QBudgeted->tranEqpPurch;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="tranEqpPurch4"
                                value="<? if(isset($row4QBudgeted->tranEqpPurch)){ echo $row4QBudgeted->tranEqpPurch; $ExpenseBud4[] = $row4QBudgeted->tranEqpPurch;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->otherEqpPurch)){ echo $row1QBudgeted->otherEqpPurch; $ExpenseBud1[] = $row1QBudgeted->otherEqpPurch;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="otherEqpPurch2"
                                value="<? if(isset($row2QBudgeted->otherEqpPurch)){ echo $row2QBudgeted->otherEqpPurch; $ExpenseBud2[] = $row2QBudgeted->otherEqpPurch;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="otherEqpPurch3"
                                value="<? if(isset($row3QBudgeted->otherEqpPurch)){ echo $row3QBudgeted->otherEqpPurch; $ExpenseBud3[] = $row3QBudgeted->otherEqpPurch;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="otherEqpPurch4"
                                value="<? if(isset($row4QBudgeted->otherEqpPurch)){ echo $row4QBudgeted->otherEqpPurch; $ExpenseBud4[] = $row4QBudgeted->otherEqpPurch;} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Capital Outlay</td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="capOutlay1"
                                value="<? if(isset($row1QBudgeted->capOutlay)){ echo $row1QBudgeted->capOutlay; $ExpenseBud1[] = $row1QBudgeted->capOutlay;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="capOutlay2"
                                value="<? if(isset($row2QBudgeted->capOutlay)){ echo $row2QBudgeted->capOutlay; $ExpenseBud2[] = $row2QBudgeted->capOutlay;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="capOutlay3"
                                value="<? if(isset($row3QBudgeted->capOutlay)){ echo $row3QBudgeted->capOutlay; $ExpenseBud3[] = $row3QBudgeted->capOutlay;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="capOutlay4"
                                value="<? if(isset($row4QBudgeted->capOutlay)){ echo $row4QBudgeted->capOutlay; $ExpenseBud4[] = $row4QBudgeted->capOutlay;} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Debt Service</td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="debtService1"
                                value="<? if(isset($row1QBudgeted->debtService)){ echo $row1QBudgeted->debtService; $ExpenseBud1[] = $row1QBudgeted->debtService;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="debtService2"
                                value="<? if(isset($row2QBudgeted->debtService)){ echo $row2QBudgeted->debtService; $ExpenseBud2[] = $row2QBudgeted->debtService;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="debtService3"
                                value="<? if(isset($row3QBudgeted->debtService)){ echo $row3QBudgeted->debtService; $ExpenseBud3[] = $row3QBudgeted->debtService;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="debtService4"
                                value="<? if(isset($row4QBudgeted->debtService)){ echo $row4QBudgeted->debtService; $ExpenseBud4[] = $row4QBudgeted->debtService;} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Miscellaneous</td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="misc1"
                                value="<? if(isset($row1QBudgeted->misc)){ echo $row1QBudgeted->misc; $ExpenseBud1[] = $row1QBudgeted->misc;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="misc2"
                                value="<? if(isset($row2QBudgeted->misc)){ echo $row2QBudgeted->misc; $ExpenseBud2[] = $row2QBudgeted->misc;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="misc3"
                                value="<? if(isset($row3QBudgeted->misc)){ echo $row3QBudgeted->misc; $ExpenseBud3[] = $row3QBudgeted->misc;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                ...
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->genFund)){ echo $row1QBudgeted->genFund; $FundsBud1[] = $row1QBudgeted->genFund;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="genFund2"
                                value="<? if(isset($row2QBudgeted->genFund)){ echo $row2QBudgeted->genFund; $FundsBud2[] = $row2QBudgeted->genFund;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="genFund3"
                                value="<? if(isset($row3QBudgeted->genFund)){ echo $row3QBudgeted->genFund; $FundsBud3[] = $row3QBudgeted->genFund;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="genFund4"
                                value="<? if(isset($row4QBudgeted->genFund)){ echo $row4QBudgeted->genFund; $FundsBud4[] = $row4QBudgeted->genFund;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->chilFirstTrust)){ echo $row1QBudgeted->chilFirstTrust; $FundsBud1[] = $row1QBudgeted->chilFirstTrust;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="chilFirstTrust2"
                                value="<? if(isset($row2QBudgeted->chilFirstTrust)){ echo $row2QBudgeted->chilFirstTrust; $FundsBud2[] = $row2QBudgeted->chilFirstTrust;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="chilFirstTrust3"
                                value="<? if(isset($row3QBudgeted->chilFirstTrust)){ echo $row3QBudgeted->chilFirstTrust; $FundsBud3[] = $row3QBudgeted->chilFirstTrust;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="chilFirstTrust4"
                                value="<? if(isset($row4QBudgeted->chilFirstTrust)){ echo $row4QBudgeted->chilFirstTrust; $FundsBud4[] = $row4QBudgeted->chilFirstTrust;} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">United Way</td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="unitedWay1"
                                value="<? if(isset($row1QBudgeted->unitedWay)){ echo $row1QBudgeted->unitedWay; $FundsBud1[] = $row1QBudgeted->unitedWay;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="unitedWay2"
                                value="<? if(isset($row2QBudgeted->unitedWay)){ echo $row2QBudgeted->unitedWay; $FundsBud2[] = $row2QBudgeted->unitedWay;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="unitedWay3"
                                value="<? if(isset($row3QBudgeted->unitedWay)){ echo $row3QBudgeted->unitedWay; $FundsBud3[] = $row3QBudgeted->unitedWay;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="unitedWay4"
                                value="<? if(isset($row4QBudgeted->unitedWay)){ echo $row4QBudgeted->unitedWay; $FundsBud4[] = $row4QBudgeted->unitedWay;} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">ADECA</td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="adeca1"
                                value="<? if(isset($row1QBudgeted->adeca)){ echo $row1QBudgeted->adeca; $FundsBud1[] = $row1QBudgeted->adeca;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="adeca2"
                                value="<? if(isset($row2QBudgeted->adeca)){ echo $row2QBudgeted->adeca; $FundsBud2[] = $row2QBudgeted->adeca;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="adeca3"
                                value="<? if(isset($row3QBudgeted->adeca)){ echo $row3QBudgeted->adeca; $FundsBud3[] = $row3QBudgeted->adeca;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="adeca4"
                                value="<? if(isset($row4QBudgeted->adeca)){ echo $row4QBudgeted->adeca; $FundsBud4[] = $row4QBudgeted->adeca;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->natlChilAlliance)){ echo $row1QBudgeted->natlChilAlliance; $FundsBud1[] = $row1QBudgeted->natlChilAlliance;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="natlChilAlliance2"
                                value="<? if(isset($row2QBudgeted->natlChilAlliance)){ echo $row2QBudgeted->natlChilAlliance; $FundsBud2[] = $row2QBudgeted->natlChilAlliance;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="natlChilAlliance3"
                                value="<? if(isset($row3QBudgeted->natlChilAlliance)){ echo $row3QBudgeted->natlChilAlliance; $FundsBud3[] = $row3QBudgeted->natlChilAlliance;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="natlChilAlliance4"
                                value="<? if(isset($row4QBudgeted->natlChilAlliance)){ echo $row4QBudgeted->natlChilAlliance; $FundsBud4[] = $row4QBudgeted->natlChilAlliance;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->chilTrustFund)){ echo $row1QBudgeted->chilTrustFund; $FundsBud1[] = $row1QBudgeted->chilTrustFund;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="chilTrustFund2"
                                value="<? if(isset($row2QBudgeted->chilTrustFund)){ echo $row2QBudgeted->chilTrustFund; $FundsBud2[] = $row2QBudgeted->chilTrustFund;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="chilTrustFund3"
                                value="<? if(isset($row3QBudgeted->chilTrustFund)){ echo $row3QBudgeted->chilTrustFund; $FundsBud3[] = $row3QBudgeted->chilTrustFund;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="chilTrustFund4"
                                value="<? if(isset($row4QBudgeted->chilTrustFund)){ echo $row4QBudgeted->chilTrustFund; $FundsBud4[] = $row4QBudgeted->chilTrustFund;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->deptOfHR)){ echo $row1QBudgeted->deptOfHR; $FundsBud1[] = $row1QBudgeted->deptOfHR;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="deptOfHR2"
                                value="<? if(isset($row2QBudgeted->deptOfHR)){ echo $row2QBudgeted->deptOfHR; $FundsBud2[] = $row2QBudgeted->deptOfHR;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="deptOfHR3"
                                value="<? if(isset($row3QBudgeted->deptOfHR)){ echo $row3QBudgeted->deptOfHR; $FundsBud3[] = $row3QBudgeted->deptOfHR;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="deptOfHR4"
                                value="<? if(isset($row4QBudgeted->deptOfHR)){ echo $row4QBudgeted->deptOfHR; $FundsBud4[] = $row4QBudgeted->deptOfHR;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->countyComm)){ echo $row1QBudgeted->countyComm; $FundsBud1[] = $row1QBudgeted->countyComm;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="countyComm2"
                                value="<? if(isset($row2QBudgeted->countyComm)){ echo $row2QBudgeted->countyComm; $FundsBud2[] = $row2QBudgeted->countyComm;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="countyComm3"
                                value="<? if(isset($row3QBudgeted->countyComm)){ echo $row3QBudgeted->countyComm; $FundsBud3[] = $row3QBudgeted->countyComm;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="countyComm4"
                                value="<? if(isset($row4QBudgeted->countyComm)){ echo $row4QBudgeted->countyComm; $FundsBud4[] = $row4QBudgeted->countyComm;} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">City Councils</td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="cityCouncil1"
                                value="<? if(isset($row1QBudgeted->cityCouncil)){ echo $row1QBudgeted->cityCouncil; $FundsBud1[] = $row1QBudgeted->cityCouncil;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="cityCouncil2"
                                value="<? if(isset($row2QBudgeted->cityCouncil)){ echo $row2QBudgeted->cityCouncil; $FundsBud2[] = $row2QBudgeted->cityCouncil;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="cityCouncil3"
                                value="<? if(isset($row3QBudgeted->cityCouncil)){ echo $row3QBudgeted->cityCouncil; $FundsBud3[] = $row3QBudgeted->cityCouncil;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="cityCouncil4"
                                value="<? if(isset($row4QBudgeted->cityCouncil)){ echo $row4QBudgeted->cityCouncil; $FundsBud4[] = $row4QBudgeted->cityCouncil;} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Local Grants</td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="localGrants1"
                                value="<? if(isset($row1QBudgeted->localGrants)){ echo $row1QBudgeted->localGrants; $FundsBud1[] = $row1QBudgeted->localGrants;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="localGrants2"
                                value="<? if(isset($row2QBudgeted->localGrants)){ echo $row2QBudgeted->localGrants; $FundsBud2[] = $row2QBudgeted->localGrants;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="localGrants3"
                                value="<? if(isset($row3QBudgeted->localGrants)){ echo $row3QBudgeted->localGrants; $FundsBud3[] = $row3QBudgeted->localGrants;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="localGrants4"
                                value="<? if(isset($row4QBudgeted->localGrants)){ echo $row4QBudgeted->localGrants; $FundsBud4[] = $row4QBudgeted->localGrants;} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Area Schools</td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="areaSchools1"
                                value="<? if(isset($row1QBudgeted->areaSchools)){ echo $row1QBudgeted->areaSchools; $FundsBud1[] = $row1QBudgeted->areaSchools;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="areaSchools2"
                                value="<? if(isset($row2QBudgeted->areaSchools)){ echo $row2QBudgeted->areaSchools; $FundsBud2[] = $row2QBudgeted->areaSchools;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="areaSchools3"
                                value="<? if(isset($row3QBudgeted->areaSchools)){ echo $row3QBudgeted->areaSchools; $FundsBud3[] = $row3QBudgeted->areaSchools;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="areaSchools4"
                                value="<? if(isset($row4QBudgeted->areaSchools)){ echo $row4QBudgeted->areaSchools; $FundsBud4[] = $row4QBudgeted->areaSchools;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->corpDonations)){ echo $row1QBudgeted->corpDonations; $FundsBud1[] = $row1QBudgeted->corpDonations;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="corpDonations2"
                                value="<? if(isset($row2QBudgeted->corpDonations)){ echo $row2QBudgeted->corpDonations; $FundsBud2[] = $row2QBudgeted->corpDonations;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="corpDonations3"
                                value="<? if(isset($row3QBudgeted->corpDonations)){ echo $row3QBudgeted->corpDonations; $FundsBud3[] = $row3QBudgeted->corpDonations;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="corpDonations4"
                                value="<? if(isset($row4QBudgeted->corpDonations)){ echo $row4QBudgeted->corpDonations; $FundsBud4[] = $row4QBudgeted->corpDonations;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<? if(isset($row1QBudgeted->privDonations)){ echo $row1QBudgeted->privDonations; $FundsBud1[] = $row1QBudgeted->privDonations;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="privDonations2"
                                value="<? if(isset($row2QBudgeted->privDonations)){ echo $row2QBudgeted->privDonations; $FundsBud2[] = $row2QBudgeted->privDonations;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="privDonations3"
                                value="<? if(isset($row3QBudgeted->privDonations)){ echo $row3QBudgeted->privDonations; $FundsBud3[] = $row3QBudgeted->privDonations;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="privDonations4"
                                value="<? if(isset($row4QBudgeted->privDonations)){ echo $row4QBudgeted->privDonations; $FundsBud4[] = $row4QBudgeted->privDonations;} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Fundraisers</td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="fundraisers1"
                                value="<? if(isset($row1QBudgeted->fundraisers)){ echo $row1QBudgeted->fundraisers; $FundsBud1[] = $row1QBudgeted->fundraisers;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="fundraisers2"
                                value="<? if(isset($row2QBudgeted->fundraisers)){ echo $row2QBudgeted->fundraisers; $FundsBud2[] = $row2QBudgeted->fundraisers;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="fundraisers3"
                                value="<? if(isset($row3QBudgeted->fundraisers)){ echo $row3QBudgeted->fundraisers; $FundsBud3[] = $row3QBudgeted->fundraisers;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="fundraisers4"
                                value="<? if(isset($row4QBudgeted->fundraisers)){ echo $row4QBudgeted->fundraisers; $FundsBud4[] = $row4QBudgeted->fundraisers;} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Bank Interest</td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="bankInterest1"
                                value="<? if(isset($row1QBudgeted->bankInterest)){ echo $row1QBudgeted->bankInterest; $FundsBud1[] = $row1QBudgeted->bankInterest;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="bankInterest2"
                                value="<? if(isset($row2QBudgeted->bankInterest)){ echo $row2QBudgeted->bankInterest; $FundsBud2[] = $row2QBudgeted->bankInterest;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="bankInterest3"
                                value="<? if(isset($row3QBudgeted->bankInterest)){ echo $row3QBudgeted->bankInterest; $FundsBud3[] = $row3QBudgeted->bankInterest;} ?>" /></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
