...
?>
			...
			<? if ($_SESSION['admin'] == 1 && $_SESSION['center'] == 99) echo '<p>1. Quarterly Reports (Unavailable)</p>';
			...
			<p>3. <a href=http://alabama.nationalchildrensalliance.org/index.php?s=3736 target=1>NCA Grant Application Process</a></p>
			<p>4. <a href=networkcalendar/>ANCAC Calendar</a></p>
			<p>5. <a href=ancacdocs/>ANCAC Shared Documents</a></p>
			<p>6. <a href=forums.php>ANCAC-Online Forums</a></p>
			<p>&nbsp;</p>
