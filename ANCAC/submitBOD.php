	...
	$error = 0;
        ...
        if ($_SESSION['admin'] == 1)
                ...
                if (($_SESSION['admin'] == 2) || ($Available == 1)){
                        if ($error == 1)
                                echo '"<script>alert(\'Please make sure that you have entered in the Board of Directors.\'); window.location.href = \'http://www.alabamacacs.org./boardOfDir.php?center='.$centerID.'\';</script>"';
                        else{
