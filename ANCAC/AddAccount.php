        ...
        if (isset($_POST['submitted'])){
             ...
             if (empty($errors)){
                 ...
                 $sqlExecute = "INSERT INTO directors ( name , username , email , center , ".
                        ...
                        "user_level , password` , phone_number , mailing_address , city , zip_code ) ".

                        "VALUES ('".$sub_User_Name."', '".$sub_User_UserName."', '".$sub_User_Email."', ".$sub_User_Center.", ".

                        " ".$sub_User_UserLevel.", '".$sub_User_Password."', '".$sub_User_PhoneNumber."','".$sub_User_MailingAddress.", ".
						
						" ".$sub_User_City."', '".$sub_User_ZipCode."')";
					...
					<?PHP
							...
							if($_SESSION['admin'] > 0){
								  ...
								  echo '<p><b>Mailing Address:</b> <input type="text" name="User_MailingAddress" maxlength="50" size="75" value="';
                                       ...
                                       if(isset($_POST['User_MailingAddress'])) echo $_POST['User_MailingAddress'];
								  ...
								  echo '<p><b>City:</b> <input type="text" name="User_City" maxlength="25" size="75" value="';
                                       ...
                                       if(isset($_POST['User_City'])) echo $_POST['User_City'];

                                  echo '" /></p>';
								  
								  
								  
								  echo '<p><b>Zip Code:</b> <input type="text" name="User_ZipCode" maxlength="12" size="75" value="';

                                       if(isset($_POST['User_ZipCode'])) echo $_POST['User_ZipCode'];
								  ...
								  echo '<p><b>Phone Number:</b> <input type="text" name="User_PhoneNumber" maxlength="15" size="75" value="';
                                       ...
                                       if(isset($_POST['User_PhoneNumber'])) echo $_POST['User_PhoneNumber'];
