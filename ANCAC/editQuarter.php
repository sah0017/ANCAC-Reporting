...
<tr>
	<td class='login-header' colspan='2' align=center><?PHP echo $CenterName; ?> Editing Quarter ending <?PHP echo $Ending; ?> - FY <?PHP echo $fiscalYear; ?><br>
        </td>
</tr>
<tr>
	          ...
	          if($_SESSION['admin'] > 1)
        	  {
                ...
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->fiTotal)){if ($row1QActual->fiTotal != -99) echo $row1QActual->fiTotal;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->fi0to6)){if ($row1QActual->fi0to6 != -99) echo $row1QActual->fi0to6;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->fi7to12)){if ($row1QActual->fi7to12 != -99) echo $row1QActual->fi7to12;} ?>" /></td>
                </tr>
                <tr align="center">
                ...
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->fiMale)){if ($row1QActual->fiMale != -99) echo $row1QActual->fiMale;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->fiFemale)){if ($row1QActual->fiFemale != -99) echo $row1QActual->fiFemale;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->fiAfrAmerican)){if ($row1QActual->fiAfrAmerican != -99) echo $row1QActual->fiAfrAmerican;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->fiAsian)){if ($row1QActual->fiAsian != -99) echo $row1QActual->fiAsian;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->fiCauc)){if ($row1QActual->fiCauc != -99) echo $row1QActual->fiCauc;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->fiHispanic)){if ($row1QActual->fiHispanic != -99) echo $row1QActual->fiHispanic;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->fiOther)){if ($row1QActual->fiOther != -99) echo $row1QActual->fiOther;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->extForenEval)){if ($row1QActual->extForenEval != -99) echo $row1QActual->extForenEval;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->intCounsSes)){if ($row1QActual->intCounsSes != -99) echo $row1QActual->intCounsSes;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->totCounSes)){if ($row1QActual->totCounSes != -99) echo $row1QActual->totCounSes;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->multDisTeamMeet)){if ($row1QActual->multDisTeamMeet != -99) echo $row1QActual->multDisTeamMeet;} ?>" /></td>
                </tr>
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->prosCases)){if ($row1QActual->prosCases != -99) echo $row1QActual->prosCases;} ?>" /></td>
                </tr>
                <tr align="center">
                ...
                <tr align="center">
                        ...
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                ...
                                value="<?PHP if(isset($row1QActual->fullTimeEmp)){if ($row1QActual->fullTimeEmp != -99.99) echo $row1QActual->fullTimeEmp;} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Personnel Costs</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->personnelCosts)){ echo number_format($row1QBudgeted->personnelCosts,2); $ExpenseBud[] = $row1QBudgeted->personnelCosts;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="personnelCosts"
                                value="<?PHP if(isset($row1QActual->personnelCosts)){if ($row1QActual->personnelCosts != -99.99){ echo $row1QActual->personnelCosts; $ExpenseAct[] = $row1QActual->personnelCosts;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Employee Benefits</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->empBenefits)){ echo number_format($row1QBudgeted->empBenefits,2); $ExpenseBud[] = $row1QBudgeted->empBenefits;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="empBenefits"
                                value="<?PHP if(isset($row1QActual->empBenefits)){if ($row1QActual->empBenefits != -99.99){ echo $row1QActual->empBenefits; $ExpenseAct[] = $row1QActual->empBenefits;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Travel-In-State</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->travelInState)){ echo number_format($row1QBudgeted->travelInState,2); $ExpenseBud[] = $row1QBudgeted->travelInState;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="travelInState"
                                value="<?PHP if(isset($row1QActual->travelInState)){if ($row1QActual->travelInState != -99.99){ echo $row1QActual->travelInState; $ExpenseAct[] = $row1QActual->travelInState;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Travel-Out-of-State</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->travelOutState)){ echo number_format($row1QBudgeted->travelOutState,2); $ExpenseBud[] = $row1QBudgeted->travelOutState;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="travelOutState"
                                value="<?PHP if(isset($row1QActual->travelOutState)){if ($row1QActual->travelOutState != -99.99){ echo $row1QActual->travelOutState; $ExpenseAct[] = $row1QActual->travelOutState;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Repairs and Maintenance</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->repairsAndMx)){ echo number_format($row1QBudgeted->repairsAndMx,2); $ExpenseBud[] = $row1QBudgeted->repairsAndMx;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="repairsAndMx"
                                value="<?PHP if(isset($row1QActual->repairsAndMx)){if ($row1QActual->repairsAndMx != -99.99){ echo $row1QActual->repairsAndMx; $ExpenseAct[] = $row1QActual->repairsAndMx;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Rentals and Leases</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->rentalsLease)){ echo number_format($row1QBudgeted->rentalsLease,2); $ExpenseBud[] = $row1QBudgeted->rentalsLease;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="rentalsLease"
                                value="<?PHP if(isset($row1QActual->rentalsLease)){if ($row1QActual->rentalsLease != -99.99){ echo $row1QActual->rentalsLease; $ExpenseAct[] = $row1QActual->rentalsLease;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Utilities and Communications</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->utilComm)){ echo number_format($row1QBudgeted->utilComm,2); $ExpenseBud[] = $row1QBudgeted->utilComm;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="utilComm"
                                value="<?PHP if(isset($row1QActual->utilComm)){if ($row1QActual->utilComm != -99.99){ echo $row1QActual->utilComm; $ExpenseAct[] = $row1QActual->utilComm;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Professional Services</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->profServ)){ echo number_format($row1QBudgeted->profServ,2); $ExpenseBud[] = $row1QBudgeted->profServ;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="profServ"
                                value="<?PHP if(isset($row1QActual->profServ)){if ($row1QActual->profServ != -99.99){ echo $row1QActual->profServ; $ExpenseAct[] = $row1QActual->profServ;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Supplies, Materials, Operations</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->suppMatOper)){ echo number_format($row1QBudgeted->suppMatOper,2); $ExpenseBud[] = $row1QBudgeted->suppMatOper;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="suppMatOper"
                                value="<?PHP if(isset($row1QActual->suppMatOper)){if ($row1QActual->suppMatOper != -99.99){ echo $row1QActual->suppMatOper; $ExpenseAct[] = $row1QActual->suppMatOper;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Transportation Equip. Purchases</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->tranEqpPurch)){ echo number_format($row1QBudgeted->tranEqpPurch,2); $ExpenseBud[] = $row1QBudgeted->tranEqpPurch;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="tranEqpPurch"
                                value="<?PHP if(isset($row1QActual->tranEqpPurch)){if ($row1QActual->tranEqpPurch != -99.99){ echo $row1QActual->tranEqpPurch; $ExpenseAct[] = $row1QActual->tranEqpPurch;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Other Equipment Purchases</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->otherEqpPurch)){ echo number_format($row1QBudgeted->otherEqpPurch,2); $ExpenseBud[] = $row1QBudgeted->otherEqpPurch;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="otherEqpPurch"
                                value="<?PHP if(isset($row1QActual->otherEqpPurch)){if ($row1QActual->otherEqpPurch != -99.99){ echo $row1QActual->otherEqpPurch; $ExpenseAct[] = $row1QActual->otherEqpPurch;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Capital Outlay</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->capOutlay)){ echo number_format($row1QBudgeted->capOutlay,2); $ExpenseBud[] = $row1QBudgeted->capOutlay;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="capOutlay"
                                value="<?PHP if(isset($row1QActual->capOutlay)){if ($row1QActual->capOutlay != -99.99){ echo $row1QActual->capOutlay; $ExpenseAct[] = $row1QActual->capOutlay;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Debt Service</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->debtService)){ echo number_format($row1QBudgeted->debtService,2); $ExpenseBud[] = $row1QBudgeted->debtService;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="debtService"
                                value="<?PHP if(isset($row1QActual->debtService)){if ($row1QActual->debtService != -99.99){ echo $row1QActual->debtService; $ExpenseAct[] = $row1QActual->debtService;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Miscellaneous</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->misc)){ echo number_format($row1QBudgeted->misc,2); $ExpenseBud[] = $row1QBudgeted->misc;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="misc"
                                value="<?PHP if(isset($row1QActual->misc)){if ($row1QActual->misc != -99.99){ echo $row1QActual->misc; $ExpenseAct[] = $row1QActual->misc;}} ?>" /></td>
                </tr>
                <?PHP
                ...
                <tr align="center">
                        ...
                        <td align="right"><?PHP if(isset($row1QBudgeted->genFund)){ echo number_format($row1QBudgeted->genFund,2); $FundsBud[] = $row1QBudgeted->genFund;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="genFund"
                                value="<?PHP if(isset($row1QActual->genFund)){if ($row1QActual->genFund != -99.99){ echo $row1QActual->genFund; $FundsAct[] = $row1QActual->genFund;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">State of AL Children First Trust</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->chilFirstTrust)){ echo number_format($row1QBudgeted->chilFirstTrust,2); $FundsBud[] = $row1QBudgeted->chilFirstTrust;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="chilFirstTrust"
                                value="<?PHP if(isset($row1QActual->chilFirstTrust)){if ($row1QActual->chilFirstTrust != -99.99){ echo $row1QActual->chilFirstTrust; $FundsAct[] = $row1QActual->chilFirstTrust;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">United Way</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->unitedWay)){ echo number_format($row1QBudgeted->unitedWay,2); $FundsBud[] = $row1QBudgeted->unitedWay;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="unitedWay"
                                value="<?PHP if(isset($row1QActual->unitedWay)){if ($row1QActual->unitedWay != -99.99){ echo $row1QActual->unitedWay; $FundsAct[] = $row1QActual->unitedWay;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">ADECA</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->adeca)){ echo number_format($row1QBudgeted->adeca,2); $FundsBud[] = $row1QBudgeted->adeca;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="adeca"
                                value="<?PHP if(isset($row1QActual->adeca)){if ($row1QActual->adeca != -99.99){ echo $row1QActual->adeca; $FundsAct[] = $row1QActual->adeca;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">National Childrens Alliance</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->natlChilAlliance)){ echo number_format($row1QBudgeted->natlChilAlliance,2); $FundsBud[] = $row1QBudgeted->natlChilAlliance;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="natlChilAlliance"
                                value="<?PHP if(isset($row1QActual->natlChilAlliance)){if ($row1QActual->natlChilAlliance != -99.99){ echo $row1QActual->natlChilAlliance; $FundsAct[] = $row1QActual->natlChilAlliance;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Childrens Trust Fund</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->chilTrustFund)){ echo number_format($row1QBudgeted->chilTrustFund,2); $FundsBud[] = $row1QBudgeted->chilTrustFund;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="chilTrustFund"
                                value="<?PHP if(isset($row1QActual->chilTrustFund)){if ($row1QActual->chilTrustFund != -99.99){ echo $row1QActual->chilTrustFund; $FundsAct[] = $row1QActual->chilTrustFund;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Department of Human Resources</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->deptOfHR)){ echo number_format($row1QBudgeted->deptOfHR,2); $FundsBud[] = $row1QBudgeted->deptOfHR;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="deptOfHR"
                                value="<?PHP if(isset($row1QActual->deptOfHR)){if ($row1QActual->deptOfHR != -99.99){ echo $row1QActual->deptOfHR; $FundsAct[] = $row1QActual->deptOfHR;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">County Commissions</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->countyComm)){ echo number_format($row1QBudgeted->countyComm,2); $FundsBud[] = $row1QBudgeted->countyComm;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="countyComm"
                                value="<?PHP if(isset($row1QActual->countyComm)){if ($row1QActual->countyComm != -99.99){ echo $row1QActual->countyComm; $FundsAct[] = $row1QActual->countyComm;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">City Councils</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->cityCouncil)){ echo number_format($row1QBudgeted->cityCouncil,2); $FundsBud[] = $row1QBudgeted->cityCouncil;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="cityCouncil"
                                value="<?PHP if(isset($row1QActual->cityCouncil)){if ($row1QActual->cityCouncil != -99.99){ echo $row1QActual->cityCouncil; $FundsAct[] = $row1QActual->cityCouncil;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Local Grants</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->localGrants)){ echo number_format($row1QBudgeted->localGrants,2); $FundsBud[] = $row1QBudgeted->localGrants;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="localGrants"
                                value="<?PHP if(isset($row1QActual->localGrants)){if ($row1QActual->localGrants != -99.99){ echo $row1QActual->localGrants; $FundsAct[] = $row1QActual->localGrants;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Area Schools</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->areaSchools)){ echo number_format($row1QBudgeted->areaSchools,2); $FundsBud[] = $row1QBudgeted->areaSchools;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="areaSchools"
                                value="<?PHP if(isset($row1QActual->areaSchools)){if ($row1QActual->areaSchools != -99.99){ echo $row1QActual->areaSchools; $FundsAct[] = $row1QActual->areaSchools;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Corporate Donations</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->corpDonations)){ echo number_format($row1QBudgeted->corpDonations,2); $FundsBud[] = $row1QBudgeted->corpDonations;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="corpDonations"
                                value="<?PHP if(isset($row1QActual->corpDonations)){if ($row1QActual->corpDonations != -99.99){ echo $row1QActual->corpDonations; $FundsAct[] = $row1QActual->corpDonations;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Private Donations</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->privDonations)){ echo number_format($row1QBudgeted->privDonations,2); $FundsBud[] = $row1QBudgeted->privDonations;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="privDonations"
                                value="<?PHP if(isset($row1QActual->privDonations)){if ($row1QActual->privDonations != -99.99){ echo $row1QActual->privDonations; $FundsAct[] = $row1QActual->privDonations;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Fundraisers</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->fundraisers)){ echo number_format($row1QBudgeted->fundraisers,2); $FundsBud[] = $row1QBudgeted->fundraisers;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="fundraisers"
                                value="<?PHP if(isset($row1QActual->fundraisers)){if ($row1QActual->fundraisers != -99.99){ echo $row1QActual->fundraisers; $FundsAct[] = $row1QActual->fundraisers;}} ?>" /></td>
                </tr>
                <tr align="center">
                        <td align="left">Bank Interest</td>
                        <td align="right"><?PHP if(isset($row1QBudgeted->bankInterest)){ echo number_format($row1QBudgeted->bankInterest,2); $FundsBud[] = $row1QBudgeted->bankInterest;} ?></td>
                        <td><input type="text" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);"
                                onkeypress="return blockNonNumbers(this, event, true, false);" class="TextInput" name="bankInterest"
                                value="<?PHP if(isset($row1QActual->bankInterest)){if ($row1QActual->bankInterest != -99.99){ echo $row1QActual->bankInterest; $FundsAct[] = $row1QActual->bankInterest;}} ?>" /></td>
                </tr>
                <?PHP
                ...
                -->
                </table>                <table id="Origin" width="100%" class="Admin" style=display:none>                                <tr>                        <td><b>Countries of Origin</td>                        <td colspan="2" align="center"><b>Current Quarter ending <?PHP echo $Ending; ?></b></td>                </tr>                <tr align="center">                        <td width="25%"><b>Country</b></td><td width="25%"><b>Number</b></td>                                        </tr>                                <tr align="center">                </tr>                <?php                         $sqlOC = "SELECT id, name FROM originCountries";                        $resultOC = @mysql_query($sqlOC) or mysql_error();                        $numRecords = mysql_num_rows($resultOC);                                while ($row = mysql_fetch_object($resultOC)) {                                echo '<tr align="center">><td align="left">'.$row->name.'</td>';                                                                echo '<td><input type="text" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);" '.                                                                          'onkeypress="return blockNonNumbers(this, event, true, false); '.                                     'class="TextInput"  name="OC'.$row->id.'" value="';                                     $sqlOCValues = "SELECT count FROM originStats WHERE center = ".$centerID." AND ".                                                "fiscalyear = ".$fiscalYear." AND quarter = ".$Quarter." AND country = ".$row->id;                                     $resultOCValues = @mysql_query($sqlOCValues) or mysql_error();                                     $rowOCValues = mysql_fetch_object($resultOCValues);                                     if(isset($rowOCValues->count)){if ($rowOCValues->count != -99){ echo $rowOCValues->count;}}                                echo '" /></td>';                                '</tr>';                                }                                ?>                </table>
                        ...
                        </form>                        </br>                 <button id=perfButton onclick="perfForm()" disabled=true >Performance Statistics</button>                 <button id=expButton onclick="expForm()">Quarterly Expenditures</button>                 <button id=fundButton onclick="fundForm()">Funding Sources</button>                 <button id=originButton onclick="originForm()">Countries of Origin</button>                        
			</td>
		</tr>
		</table>
