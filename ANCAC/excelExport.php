<?php
	...
	//lines 6-11 force the browser to save the database into the specified file
	...
	//Everything below is just a copy of GrandTotal.php - I hope to find a way where this is not neccessary
