<?
	...
	$centerID = $_POST['centerID'];
        ...
        if ($numRecords > 0){
              while ($row = mysql_fetch_object($resultOE)) {
                //Actual1
                $oeInputBox = "OE1Q".$row->OExpenseID;
                $oePostValue = set_Variable($_POST[$oeInputBox]);

                $sqlExecute = "UPDATE budgetedOtherExpense SET oeValue = '".$oePostValue."' ".
                                "WHERE center = '".$centerID."' AND fiscalyear = '".$fiscalYear."' ".
                                "AND quarter = '1' AND OExpenseID = '".$row->OExpenseID."'";
                                
                //Run the Executed statement to insert the Other Expense1
                $resultExecute = @mysql_query($sqlExecute);
                ...
                if ($intDidUpdate == 0){
                        $sqlExecute = "INSERT INTO `budgetedOtherExpense` ( `center` , `fiscalyear` , `quarter` , `OExpenseID` , `oeValue` ) ".
                                "VALUES ('".$centerID."', '".$fiscalYear."', '1', '".$row->OExpenseID."', '".$oePostValue."')";
                ...
                //Actual2
                $oeInputBox = "OE2Q".$row->OExpenseID;
                $oePostValue = set_Variable($_POST[$oeInputBox]);
                
                $sqlExecute = "UPDATE budgetedOtherExpense SET oeValue = '".$oePostValue."' ".
                                "WHERE center = '".$centerID."' AND fiscalyear = '".$fiscalYear."' ".
                                "AND quarter = '2' AND OExpenseID = '".$row->OExpenseID."'";
                                
                 //Run the Executed statement to insert the Other Expense2
                $resultExecute = @mysql_query($sqlExecute);
                ...
                if ($intDidUpdate == 0){
                        $sqlExecute = "INSERT INTO `budgetedOtherExpense` ( `center` , `fiscalyear` , `quarter` , `OExpenseID` , `oeValue` ) ".
                                "VALUES ('".$centerID."', '".$fiscalYear."', '2', '".$row->OExpenseID."', '".$oePostValue."')";
                ...
                //Actual3
                $oeInputBox = "OE3Q".$row->OExpenseID;
                $oePostValue = set_Variable($_POST[$oeInputBox]);
                
                $sqlExecute = "UPDATE budgetedOtherExpense SET oeValue = '".$oePostValue."' ".
                                "WHERE center = '".$centerID."' AND fiscalyear = '".$fiscalYear."' ".
                                "AND quarter = '3' AND OExpenseID = '".$row->OExpenseID."'";
                                
                //Run the Executed statement to insert the Other Expense3
                $resultExecute = @mysql_query($sqlExecute);
                ...
                if ($intDidUpdate == 0){
                        $sqlExecute = "INSERT INTO `budgetedOtherExpense` ( `center` , `fiscalyear` , `quarter` , `OExpenseID` , `oeValue` ) ".
                                "VALUES ('".$centerID."', '".$fiscalYear."', '3', '".$row->OExpenseID."', '".$oePostValue."')";
                ...
                //Actual4
                $oeInputBox = "OE4Q".$row->OExpenseID;
                $oePostValue = set_Variable($_POST[$oeInputBox]);
                
                $sqlExecute = "UPDATE budgetedOtherExpense SET oeValue = '".$oePostValue."' ".
                                "WHERE center = '".$centerID."' AND fiscalyear = '".$fiscalYear."' ".
                                "AND quarter = '4' AND OExpenseID = '".$row->OExpenseID."'";
                                
                //Run the Executed statement to insert the Other Expense4
                $resultExecute = @mysql_query($sqlExecute);
                ...
                if ($intDidUpdate == 0){
                        $sqlExecute = "INSERT INTO `budgetedOtherExpense` ( `center` , `fiscalyear` , `quarter` , `OExpenseID` , `oeValue` ) ".
                                "VALUES ('".$centerID."', '".$fiscalYear."', '4', '".$row->OExpenseID."', '".$oePostValue."')";

                        //Run the Executed statement to insert the County Info
                        $resultExecute = @mysql_query($sqlExecute);
                }
              }
        }//END of the IF for Other Expense4
        ...
        if ($numRecords > 0){
              while ($row = mysql_fetch_object($resultOI)) {
                //Actual1
                $oiInputBox = "OI1Q".$row->OIncomeID;
                $oiPostValue = set_Variable($_POST[$oiInputBox]);
                
                $sqlExecute = "UPDATE budgetedOtherIncome SET oiValue = '".$oiPostValue."' ".
                                "WHERE center = '".$centerID."' AND fiscalyear = '".$fiscalYear."' ".
                                "AND quarter = '1' AND OIncomeID = '".$row->OIncomeID."'";
                                
                //Run the Executed statement to insert the Other Income1
                $resultExecute = @mysql_query($sqlExecute);
                ...
                //If it did not Update, insert
                if ($intDidUpdate == 0){
                        $sqlExecute = "INSERT INTO `budgetedOtherIncome` ( `center` , `fiscalyear` , `quarter` , `OIncomeID` , `oiValue` ) ".
                                "VALUES ('".$centerID."', '".$fiscalYear."', '1', '".$row->OIncomeID."', '".$oiPostValue."')";
                ...
                //Actual2
                $oiInputBox = "OI2Q".$row->OIncomeID;
                $oiPostValue = set_Variable($_POST[$oiInputBox]);
                
                $sqlExecute = "UPDATE budgetedOtherIncome SET oiValue = '".$oiPostValue."' ".
                                "WHERE center = '".$centerID."' AND fiscalyear = '".$fiscalYear."' ".
                                "AND quarter = '2' AND OIncomeID = '".$row->OIncomeID."'";
                ...
                if ($intDidUpdate == 0){
                        $sqlExecute = "INSERT INTO `budgetedOtherIncome` ( `center` , `fiscalyear` , `quarter` , `OIncomeID` , `oiValue` ) ".
                                "VALUES ('".$centerID."', '".$fiscalYear."', '2', '".$row->OIncomeID."', '".$oiPostValue."')";
                ...
                //Actual3
                $oiInputBox = "OI3Q".$row->OIncomeID;
                $oiPostValue = set_Variable($_POST[$oiInputBox]);
                
                 $sqlExecute = "UPDATE budgetedOtherIncome SET oiValue = '".$oiPostValue."' ".
                                "WHERE center = '".$centerID."' AND fiscalyear = '".$fiscalYear."' ".
                                "AND quarter = '3' AND OIncomeID = '".$row->OIncomeID."'";
                ...
                if ($intDidUpdate == 0){
                        $sqlExecute = "INSERT INTO `budgetedOtherIncome` ( `center` , `fiscalyear` , `quarter` , `OIncomeID` , `oiValue` ) ".
                                "VALUES ('".$centerID."', '".$fiscalYear."', '3', '".$row->OIncomeID."', '".$oiPostValue."')";
                ...
                //Actual4
                $oiInputBox = "OI4Q".$row->OIncomeID;
                $oiPostValue = set_Variable($_POST[$oiInputBox]);
                
                $sqlExecute = "UPDATE budgetedOtherIncome SET oiValue = '".$oiPostValue."' ".
                                "WHERE center = '".$centerID."' AND fiscalyear = '".$fiscalYear."' ".
                                "AND quarter = '4' AND OIncomeID = '".$row->OIncomeID."'";
                ...
                if ($intDidUpdate == 0){
                        $sqlExecute = "INSERT INTO `budgetedOtherIncome` ( `center` , `fiscalyear` , `quarter` , `OIncomeID` , `oiValue` ) ".
                                "VALUES ('".$centerID."', '".$fiscalYear."', '4', '".$row->OIncomeID."', '".$oiPostValue."')";

                        //Run the Executed statement to insert the County Info
                        $resultExecute = @mysql_query($sqlExecute);
                }
              }
        }//END of the IF for Other Income4
	...
	{
                if ($CY == 1)
                      header('Location: http://www.alabamacacs.org/ANCAC-Online/editBudgets.php?center='.$centerID.'&Y=1');
                else
		      header('Location: http://www.alabamacacs.org/ANCAC-Online/editBudgets.php?center='.$centerID);
	}
	else
	{
                header('Location: http://www.alabamacacs.org/ANCAC-Online/editBudgets.php');
        }
?>