<?PHP
	...
	{
                if ($CY == 1)
                      header('Location: http://'.$_SERVER['HTTP_HOST'].$webroot.'editBudgets.php?center='.$centerID.'&Y=1');
                else
		      header('Location: http://'.$_SERVER['HTTP_HOST'].$webroot.'editBudgets.php?center='.$centerID);
	}
	else
	{
                header('Location: http://'.$_SERVER['HTTP_HOST'].$webroot.'editBudgets.php');
        }
?>